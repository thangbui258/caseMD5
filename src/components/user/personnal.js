        ...
        <div>
            <header className="flex items-center justify-between bg-gray-800 text-sm text-white py-4 px-4">
                <div className="flex items-center">
                    ...
                    <div className="flex">
                        <a className="mr-3 font-semibold hover:text-gray-400">Pull requests</a>
                        <a className="mr-3 font-semibold hover:text-gray-400">Issues</a>
                        <a className="mr-3 font-semibold hover:text-gray-400">Marketplace</a>
                        <a className="mr-3 font-semibold hover:text-gray-400">Explore</a>
                    </div>
                </div>
                <div className="flex">
